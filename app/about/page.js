    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="px-5 pt-8 pb-10">
          ...
          <h1 className="text-3xl font-extrabold text-[#1E3A8A] mb-6">
            About TalentFlow
          </h1>
          ...
          <div className="space-y-4">
            <h2 className="text-xl font-extrabold text-gray-900 leading-snug">
              <span className="text-[#F59E0B]">TalentFlow</span> Is A Modern
              Learning Platform Designed To Empower Students.
            </h2>
        ...
        <section className="px-5 pb-10 bg-white">
          ...
          <div className="space-y-4">
            <p className="text-[#1E3A8A] font-bold text-lg">Features</p>
        ...
        <section className="px-5 py-10 bg-[#f8fafc]">
          ...
          <div className="text-center mb-10">
            <p className="text-[#1E3A8A] font-bold text-lg mb-2">Our Benefits</p>
